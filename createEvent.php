...
<fieldset class="mt-3">
   ...
   <form  action="actions/a_createEvent.php" method= "post">
       <table cellspacing= "0" cellpadding="0">
           ...
           <tr>
               <th>Event Date</th>
               <td><input type="date"  name="event_Date" placeholder ="Event Date" /></td>
           </tr>
           <tr>
               <th>Event Time</th>
               
               <td><input type="time"  name="event_time" placeholder ="Event Time" /></td>
           </tr>
           <tr>
               <th>Price</th>
           ...
           <tr>
               ...
               <td><a href= "adminpanelEvent.php"><button class="btn btn-danger px-5 my-2" type="button"><i class="fas fa-arrow-left"></i></button></a></td>
           </tr>
       </table>
   </form>
