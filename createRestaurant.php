...
<fieldset class="mt-3 ">
   <legend style="font-weight: bold; font-size: 20pt;">Create new Restaurant</legend>

   <form class="mt-3" action="actions/a_createRestaurant.php" method= "post">
       <table cellspacing= "0" cellpadding="0">
           ...
           <tr>
               <th>Websitee</th>
               <td><input  type="text" name="webpage" placeholder="Webpage"/></td>
           </tr>
           <tr>
               <th>Image</th>
           ...
           <tr>
               ...
               <td><a href= "adminpanelRestaurant.php"><button class="btn btn-danger px-5 my-2" type="button"><i class="fas fa-arrow-left"></i></button></a></td>
           </tr>
       </table>
   </form>
