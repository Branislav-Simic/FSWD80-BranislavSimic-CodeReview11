...
<p class="mt-5">Do you really want to delete this restaurant?</p>
<form action ="actions/a_deleteRestaurant.php" method="post">
   ...
   <a href="adminpanelRestaurant.php"><button class="btn btn-danger" type="button">No, go back!</button ></a>
</form>
