...
<style>
  .jumbotron{
    background: url('https://images.unsplash.com/photo-1524862655266-89c67a10c4b3?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=80')70%;
...
<body >
 ...
 <div class="fluid-container">
  ...
  <p class="leadJumbo">Discover the Things to do in Vienna<br>   
 and  find Things to do in the nicest city</p>
</div>
...
echo"   <div class='offset-1 d-flex align-items-center'>
