   ...
   <form action="actions/a_updateRestaurant.php"  method="post">
       <table  cellspacing="0" cellpadding= "0">
           <tr>
               ...
               <td><input type="text"  name="name" placeholder ="Restaurant Name" value="<?php echo $data['name'] ?>"  /></td>
           </tr>    
           <tr>
               <th>Phone Number</th>
           ...
           <tr>
               ...
               <td><a  href= "adminpanelRestaurant.php"><button class="btn btn-danger px-5"  type="button" ><i class="fas fa-arrow-left"></i></button ></a ></td >
           </tr>
       </table>
   </form >
